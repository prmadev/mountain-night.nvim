...
local highlight_groups = {
	...
	TabLine = function(self)
		return { fg = FG, bg = self.StatusLine.bg }
	end,
	...
	markdownH1 = { fg = black, bg = green, style = "bold" },
	markdownH1Delimiter = { fg = black, bg = green, style = "bold" },
	markdownH2 = { fg = black, bg = orange, style = "bold" },
	markdownH2Delimiter = { fg = black, bg = orange, style = "bold" },
	markdownH3 = { fg = black, bg = blue, style = "bold" },
	markdownH3Delimiter = { fg = black, bg = blue, style = "bold" },
	markdownH4 = { fg = black, bg = yellow, style = "bold" },
	markdownH4Delimiter = { fg = black, bg = yellow, style = "bold" },
	markdownH5 = { fg = black, bg = cyan, style = "bold" },
	...
	TSPunctSpecial = { fg = black, bg = purple, style = "bold" },
	--[[ 4.3.20. Python ]]
