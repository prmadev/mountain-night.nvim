...
local highlight_groups = {
	...
	markdownH2Delimiter = "markdownH1",
	markdownH3 = {  fg = blue, style = "bold" },
	markdownH3Delimiter = "markdownH1",
	markdownH4 = {  fg = yellow, style = "bold" },
	markdownH4Delimiter = "markdownH1",
	markdownH5 = {  fg = cyan, style = "bold" },
	markdownH5Delimiter = "markdownH1",
	markdownH6 = {  fg = purple, style = "bold" },
	markdownH6Delimiter = "markdownH1",
